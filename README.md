...
<meta charset="utf-8">
<title>张强的简历-拉勾网-最专业的互联网招聘平台</title>
		...
		<div class="mr_myresume_l mrcenter">
			<div id="mr_mr_head">
				<div class="m_portrait mr_top_bg">
					...
					<img src="http://www.lagou.com/i/image/M00/34/BE/CgpEMlk7temAaT7VAAJNiFHsNmU058.jpg" width="120" height="120" alt="" />
				</div>
				<div class="mr_baseinfo">
					<i class="mr_left_bg"></i>
					<i class="mr_right_bg"></i>
					<div class="mr_p_name mr_w604 clearfixs">
						<span class="mr_name">张强</span>
					</div>
					<div class="mr_p_introduce mr_w604 clearfixs">
						<span class="mr_intro">1年JAVA开发经验,负责两个项目的开发,有自学和解决问题的能力</span>
					</div>
					<div class="mr_p_info mr_infoed mr_w604 clearfixs">
						...
						<div class="info_t">
							...
							<span class="job_span">&nbsp;2年工作经验</span><span class="birth_span dn">1993.03年出生</span>&nbsp;&nbsp;&nbsp;上海</span>
						</div>
						<div class="info_b">
							<span class="mobile"><i></i>15201973310</span>&nbsp;&nbsp;
							<span class="email"><i></i>zhangqiang_0326@163.com</span>
						</div>
						<div class="mr_sns">
						<!--   -------------------社交账号     -----------------       -->
						</div>
							...
							<div class="list_show">
								...
								<div class="clearfixs">
									...
									<div class="mr_content_r">
										<span>2016.08 -- 至今</span>
									</div>
								</div>

								<div class="mr_content_m olpf">
									<p>分析上海电渠下发的项目需求文档；&nbsp;<br />根据每周制定的开发进度和任务分配，进行后端开发；&nbsp;<br />进行程序单元、功能的测试，查出软件存在的缺陷并保证其质量；&nbsp;<br />要求每个完成的模块都有对应的测试报告；&nbsp;<br />后期维护以及二次开发</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									...
									<div class="mr_content_r">
										<span>2015.05 -- 2016.06</span>
									</div>
								</div>

								<div class="mr_content_m olpf">
									<p>根据开发文档文档完成软件的开发工作。&nbsp;</p>
<p>负责编写软件更改说明、功能特性说明等开发文档。</p>
<p>负责组织、配合项目、产品的测试工作、负责代码的实现。</p>
								</div>
								</div>
							</div>
							</div>
								...
								<div class="clearfixs mb46 mr_jobe_list">
									<div class="mr_content_l">
										<div class="l1">
											...
											<img src="http://www.lagou.com/images/schoolBadge/0ed58b8a4d3345128bb5b161a4a69875.jpeg"/>
										</div>
										<div class="l2">
											<h4>湖北文理学院</h4>
						...
						<div>
							...
							<div class="mr_moudle_content" id="projectList">
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle"  target="_blank" href="http://sh.189.cn"><span></span>上海电信网上营业厅(sh.189.cn)</a>
											<p>负者老用户维系</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2017.04 -- 2017.06</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>该项目主要是为方便上海电信用户办理各种业务而开发的网上营业厅,项目依靠Maven管理jar包,同时支持微信访问,采用SpringMVC为核心,通过配合ibatis提供前端需要的controller地址,配置了拦截器去拦截登录过期或者未登录的请求,同时配置了每个请求的日志入数据库保障有日志可查,数据库采用Oracle,日常开发中都会去调用集团的webservices接口获取信息,一些长时间内不会改变的热门数据采用Redis缓存来减轻调用接口的压力，订单生成后会由老用户维系订单管理去查询订单的状态直到办结</p>
<p>在项目中主要负责网厅中的老用户维系,主要包括:用户从下单到验证、认证再到提交订单再到支付等;政企模块,主要面对的是政企用户办理一系列业务；其他的还包括:移机、故障报修、催装、评价、单元测试等</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">老用户维系订单管理</a>
											<p>负责整个流程的控制以及代码的实现</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2017.03 -- 2017.06</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>该系统是以员工套餐订单管理为模型,用户生成的订单信息都可以在该系统中看到，主要包括:订单查询、订单处理、订单详情、购机详情、活体详情、甩单详情、物流信息、订单导出等,架构同样采用SpringMVC+ibatis为后台核心,通过对应spring的定时器去调用集团、Erp的webservices接口去管理订单的状态直到办结为止,前端主要采用Jquery+EasyUI</p>
<p>负责整个流程的控制以及代码的实现,后端提供查询订单状态的接口以及修改订单状态和订单入Erp内库中,以及订单完成后的邮件、短信提醒</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">上海电信员工套餐</a>
											<p>主要负责后端代码,给前端提供接口地址,项目的部署、单元测试</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2016.08 -- 2017.03</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									<p>该系统是以员工套餐订单管理为模型,用户生成的订单信息都可以在该系统中看到，主要包括:订单查询、订单处理、订单详情、购机详情、活体详情、甩单详情、物流信息、订单导出等,架构同样采用SpringMVC+ibatis为后台核心,通过对应spring的定时器去调用集团、Erp的webservices接口去管理订单的状态直到办结为止,前端主要采用Jquery+EasyUI</p>
								...
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">员工套餐订单管理</a>
											<p>主要参加编码，单元测试，代码维护，项目部署</p>
										</div>
									</div>
								...
								<div class="mr_content_m olpf">
									<p>该套餐主要面向的电信内部员工,通过变更套餐可以以优惠价格购买手机,我主要负责的是从生成订单到支付的全过程,在生成过程中要求员工提供自己的员工号码来验证,同时需要调用集团的活体认证来进行验证才能提交订单,支付环节是调用集团的提供的第三方支付接口,订单提交后交由员工套餐后台管理区刷新订单的状态</p>
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">汉江地质保护办公系统</a>
											<p>项目维护、附件管理、权限管理以及登陆、注册</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2015.11 -- 2016.06</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									项目技术介绍：Spring-MVC + Mybatis + JQuery + EasyUI+SQLServer
办公人员根据账号进行登录,如果没有账号可以先注册一个,登录和注册页面是使用EasyUI实现的,注册成功后由管理员审核通过后才能登录,登录成功后账号的相关信息保存在session中,不同的角色有不同的权限, 只有管理员有更新的权限,项目立项是根据项目的相关信息录入项目并上传相应的附件,录入的界面采用EsyUI实现,录入成功后可以对项目的名称、成立时间、类型、竣工时间进行模糊查询,也可以在附件管理中对上传的附件进行管理
								</div>
								</div>
								<div class="mr_jobe_list">
								<div class="clearfixs">
									<div class="mr_content_l">
										<div class="l2">
											<a class="projectTitle nourl">随州市生态文明管理系统</a>
											<p>项目立项、权限管理以及登陆、注册</p>
										</div>
									</div>

									<div class="mr_content_r">
										<span>2015.05 -- 2015.11</span>
									</div>
								</div>
								<div class="mr_content_m olpf">
									项目技术介绍：Struts + Hibernate + Spring +Jquery+Oracle
登陆和注册使用Ajax对表单进行验证,登录成功后相关的信息保存在session中,由拦截器来判断用户的权限，项目立项分为：县级项目、市级项目,不同级别的项目申请时走的审批流程不同,县级项目是由县牵头部门、县生态办审批,市级是由县牵头部门、县生态办、市牵头部门、市生态办审批通过,如果有一个环节不通过则项目进入复核状态,如果项目立项成功则进入下一个环节。
								</div>
								</div>
							</div>
						</div>
						...
						<div>
							...
							<div class="mr_moudle_content clearfixs">
								<div class="mr_self_l">
									...
									<i></i>
									<img src="http://www.lagou.com/i/image/M00/34/BE/CgpEMlk7temAaT7VAAJNiFHsNmU058.jpg" alt="张强"/>
								</div>
								<div class="mr_self_r">
									<p>2年web项目开发经验,有进行独立开发的能力，熟练掌握JAVA/J2EE语言开发技术。<br />具有良好的编码风格和学习能力,具备良好的沟通能力。<br />工作认真负责,有独立解决问题的能力,为人和善,良好的团队合作意识</p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="mr_moudle_content clearfixs mr_w604">
							<div class="expectjob_list">
								...
								<div class="mr_job_info" data-id="$!expectJobses.id">
									<ul class="clearfixs">
										<li class="mr_name_li" ><i></i><span class="mr_job_name" title="java软件开发工程师">java软件开发工程师</span></li>
										<li class="mr_jobtype_li"> <i></i><span class="mr_job_type" title="$!expectJobses.positionType">全职</span></li>
										<li class="mr_city_li"> <i></i><span class="mr_job_adr" title="$!expectJobses.city">上海</span></li>
						...
						<div>
							...
							<div class="mr_moudle_content">
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="JAVA/J2EE">JAVA/J2EE</span>
								...
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="JQuey EasyUI HTML JavaScript Css">JQuey EasyUI HTML JavaScript Css</span>
									<span class="mr_skill_plan" data-skillLevel = "56">
									 <em style="width: 56%"></em>
									</span>
									<span class="mr_skill_level">掌握</span>
								</div>
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="SSH、Ibatis/Mybatis、SpringMVC">SSH、Ibatis/Mybatis、SpringMVC</span>
								...
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="MySql Oracle SQLServer 各种开发工具">MySql Oracle SQLServer 各种开发工具</span>
									<span class="mr_skill_plan" data-skillLevel = "55">
									 <em style="width: 55%"></em>
									</span>
									<span class="mr_skill_level">掌握</span>
								...
								<div class="mr_skill_con">
									<span class="mr_skill_name" title="Linux命令 Maven 各种版本控制工具">Linux命令 Maven 各种版本控制工具</span>
									<span class="mr_skill_plan" data-skillLevel = "22">
									 <em style="width: 22%"></em>
									</span>
									<span class="mr_skill_level">熟悉</span>
								</div>
							</div>
						</div>
					</div>
